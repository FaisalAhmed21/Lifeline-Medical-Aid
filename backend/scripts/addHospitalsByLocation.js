...
const addHospitals = async () => {
  try {
  const mongoUri = process.env.MONGODB_URI || 'mongodb://localhost:27017/lifeline_db';
  const isAtlas = process.env.MONGODB_URI && process.env.MONGODB_URI.startsWith('mongodb+srv');
